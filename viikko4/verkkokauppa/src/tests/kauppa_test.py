...
class TestKauppa(unittest.TestCase):
    ...
    def test_osta_kaksi_erilaista(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
    ...
    def test_osta_kaksi_samanlaista(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(1)
        self.kauppa.lisaa_koriin(1)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_ostos_loppuunmyydylla(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
    ...
    def test_edellinen_asiointi_ei_vaikuta_tuleviin(self):
        self.kauppa.aloita_asiointi()
        self.kauppa.lisaa_koriin(2)
        self.kauppa.tilimaksu("pekka", "12345")
    ...
    def test_kauppa_pyytaa_viitenumeroa_per_maksutapahtuma(self):
        ...
        self.kauppa.lisaa_koriin(2)
        self.kauppa.tilimaksu("pekka", "12345")
        self.pankki_mock.tilisiirto.assert_called_with("pekka", 43, "12345", ANY, 3)

    def test_poistaminen_korista_palauttaa_tuotteen_varastoon(self):
        varasto_mock = Mock()
        pankki_mock = Mock()
